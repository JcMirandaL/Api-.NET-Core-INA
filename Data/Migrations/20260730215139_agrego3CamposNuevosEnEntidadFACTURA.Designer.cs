...
namespace InaApp.Data.Migrations
{
    ...
    [Migration("20260730215139_agrego3CamposNuevosEnEntidadFACTURA")]
    partial class agrego3CamposNuevosEnEntidadFACTURA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InaApp.Entities.DetalleFactura", b =>
                {
            ...
            modelBuilder.Entity("InaApp.Entities.Factura", b =>
                {
                    ...
                    b.Property<int?>("FacturaReferenciaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FacturaReferenciaId");
            ...
            modelBuilder.Entity("InaApp.Entities.Producto", b =>
                {
                    ...
                    b.Property<int>("DescuentoMaximo")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ImpuestoAplicable")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InaApp.Entities.Factura", b =>
                {
                    ...
                    b.HasOne("InaApp.Entities.Factura", "FacturaReferencia")
                        .WithMany()
                        .HasForeignKey("FacturaReferenciaId")
